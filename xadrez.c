...
void  retorno1 ( int  movimento1 ){    // Cancelamento do controle da Torre.
...
int  main (){   // Informando as variáveis ​​de controle .
 inttorre  = 5 ;  ​  // Quantidade de movimentos da torre.
